...
echo  -e "\e[32m>>>> creating catalogue service  <<<<\e[0m"   | tee -a ${log}
...
echo  -e "\e[32m>>>> cleaning directory  <<<<\e[0m"   | tee -a ${log}
rm -rf /app  &>>${log}

mkdir /app
echo  -e "\e[32m>>>> dowlnloading zip <<<<\e[0m"   | tee -a ${log}
curl -o /tmp/catalogue.zip https://roboshop-artifacts.s3.amazonaws.com/catalogue.zip   &>>${log}
echo  -e "\e[32m>>> extracting zip <<<\e[0m"   | tee -a ${log}
cd /app
